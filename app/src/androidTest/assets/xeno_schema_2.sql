...
--
-- Date: Mon May 07 01:53:05 CEST 2018
--
-- This file was generated by Kripton Annotation Processor v. 4.0.0-rc.7
--
------------------------------------------------------------------------------------
...
CREATE TABLE phone_number (id INTEGER PRIMARY KEY AUTOINCREMENT, action TEXT, number TEXT UNIQUE, country_code TEXT, contact_name TEXT, contact_id TEXT);
